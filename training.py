...
def training(model, train_loader, validation_loader, criterion, optimizer, num_epochs=num_epochs, model_path="best_model.pth"):
    ...
    for epoch in range(num_epochs):
        ...
        print(f"Epoch {epoch+1}, Validation Loss: {validation_loss},  Final Passthrough Accuracy: {round((correct / total * 100), 2)}")  # print info for developer
        ...
        if validation_loss < best_loss:
            ...
            patience_count += 1
            if patience_count >= 4:  # patience of 4
